...
class Controller:
    ...
    #     currentBrightnessLv.append(Controller.pinchlv / 50.0)
    #     if currentBrightnessLv[-1] > 1.0:
    #         currentBrightnessLv[-1] = 1.0
    #     elif currentBrightnessLv[-1] < 0.0:
    #         currentBrightnessLv[-1] = 0.0       
    #     sbcontrol.fade_brightness(int(100*currentBrightnessLv[-1]) , start = sbcontrol.get_brightness(display=0))
    ...
    def pinch_control(hand_result, controlHorizontal, controlVertical):
        ...
        if Controller.framecount == 5:
            ...
            if Controller.pinchdirectionflag == True:
                # Controller.changesystembrightness(hand_result)#x
                controlHorizontal() #y
